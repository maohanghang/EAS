...
<head>
        ...
        <meta name="robots" content="湖南学教务处">
                                ...
                                <div class="block-content block-content-narrow">
                                    ...
                                    <form class="form-horizontal push-12-t" action="${pageContext.request.contextPath}/AddStudent" method="post" >
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-password2" name="Sname">
                                                    <label for="material-password2">学生姓名</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-name" name="Ssex">
                                                    <label for="material-name">性别</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="Sbirth">
                                                    <label for="material-phone">出生日期</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="Classno">
                                                    <label for="material-phone">班级编号</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="Password">
                                                    <label for="material-phone">密码</label>
                                                </div>
                                            </div>
                                        </div>
