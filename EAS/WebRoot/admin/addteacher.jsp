                                ...
                                <div class="block-content block-content-narrow">
                                    ...
                                    <form class="form-horizontal push-12-t" action="${pageContext.request.contextPath}/AddTeacher" method="post" >
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-text2" name="Tno">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-password2" name="Tname">
                                                    <label for="material-password2">教师姓名</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-name" name="Title">
                                                    <label for="material-name">职称</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="Tel">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-phone" name="Dno">
                                                    <label for="material-phone">所属系号</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
