            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/photo12@2x.jpg');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn">教师管理</h1>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                <thead>
                                 ...
                                 <% 
                                    	...
                                    	List userAllteacher= aDAO.selectAllteacher();
                                    	System.out.println(userAllteacher.size());
                                    	request.setAttribute("userAllteacher", userAllteacher); 
                                  
                                     %>
                                <tbody>
                                <c:forEach items="${userAllteacher}" var="item" varStatus="status">  
								  <tr>
                                   
                                        <td class="text-center">${status.index+1}</td>
                                        <td class="font-w600">${item.getTno() }</td>
                                        <td class="font-w600">${item.getTname() }</td>
                                        <td class="hidden-xs">${item.getTitle() }</td>
                                        <td class="hidden-xs">${item.getTel() }</td>
                                        <td class="hidden-xs">${item.getDno() }</td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" 
                                                title="Edit Client" onclick="edit('${item.getTno() }',
                                                                                  '${item.getTname() }',
                                                                                  '${item.getTitle() }',
                                                                                  '${item.getTel() }',
                                                                                  '${item.getDno() }')">
                                                <i class="fa fa-pencil"></i></button>
                                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove Client" onclick="del('${item.getTno()}')"><i class="fa fa-times"></i></button>
                                            </div>
                                        </td>
                                    </tr> 
								</c:forEach>                                    
    ...
    <form action="${pageContext.request.contextPath}/UpdateTeacher" method="post">
            ...
            <div class="modal-body">
            	...
            	<div class="form-group">
                    <input type="text" class="form-control" id="tno" placeholder="教师号" name="tno" readonly="true">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="tname" name="tname" placeholder="姓名">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="title" name="title" placeholder="职称" >
                </div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="dno" name="dno" placeholder="部门号" >
                </div>
...
<script type="text/javascript">
     ...
     *编辑方法
     **/
    function edit(tno,tname,title,tel,dno) {
        console.log(name);
        editFlag = true;
