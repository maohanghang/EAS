...
<head>
                                                ...
                                                <table class="table remove-margin-b font-s13">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right" style="width: 70px;">${admin.getAno() }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">姓名：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${admin.getAname() }</td>
                                                        </tr>
                                                        <tr>
   ...
   <c:otherwise>
         学生  
                                                        ...
                                                        <tr>
                                                            <td class="font-w600">密码：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${admin.getPassword() }</td>
                                                        </tr>
