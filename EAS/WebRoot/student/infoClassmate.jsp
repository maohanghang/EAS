            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/photo12@2x.jpg');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn">查看课程</h1>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">同班同学信息表 <small>All</small></h3>
                        </div>
                        <div class="block-content">
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <% 
                                    	...
                                    	List info = stu.getClassmateInfo(student.getClassno());
                                ...
                                <c:forEach items="${info}" var="item" varStatus="status"> 
								  <tr>
                                        ...
                                        <td class="font-w600">${item.getSsex() }</td>
                                        <td class="font-w600">${item.getSbirth() }</td>
