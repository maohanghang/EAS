                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content left-menu-wrap">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="infoCourse.jsp"><i class="si si-badge"></i><span class="sidebar-mini-hide">查看课程信息</span></a>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-narrow">
                                    ...
                                    <form class="form-horizontal push-12-t" action="${pageContext.request.contextPath}/alterPassword" method="post" >
                      					<!--  <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    ...
                                                    <label for="material-text2">当前学生的id</label>
                                                </div>
                                            </div>
                                        </div>-->
                                        <%
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-text2" name="oldpassword">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-password2" name="newpassword">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material form-material-info floating">
                                                    <input class="form-control" type="text" id="material-name" name="confirmpassword">
