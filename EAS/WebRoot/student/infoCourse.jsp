                        ...
                        <div class="block-content">
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <% 
                                    	...
                                    	List info=stu.getCourseInfo(student.getSname());
                                ...
                                <c:forEach items="${info}" var="item" varStatus="status"> 
								  <tr>
                                        ...
                                        <td class="font-w600">${item.sname }</td>
                                        <td class="font-w600">${item.cname }</td>
                                        <td class="font-w600">${item.tname }</td>
                                        <td class="hidden-xs">${item.grade}</td>
