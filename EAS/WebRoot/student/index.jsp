                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="index.jsp">
                                <span class="h4 font-w600 sidebar-mini-hide">学生教务管理系统</span>
                            </a>
                        </div>
                        ...
                        <div class="side-content left-menu-wrap">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="infoCourse.jsp"><i class="si si-badge"></i><span class="sidebar-mini-hide">查看课程</span></a>
                                ...
                                <li >
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="infoClassmate.jsp"><i class="si si-badge"></i><span class="sidebar-mini-hide">查看同学信息</span></a>                                 
                                </li>
                            </ul>
                        </div>
                        <!-- END Side Content -->
                        <div class="side-header side-content bg-white-op left-menu_account">
                            ...
                            <a class="h5 text-white" href="index.jsp">
                                <span class="h4 font-w600 sidebar-mini-hide"><c:if test="${student!=null }">${student.sname}
								</c:if>
								</span>
                            </a>
                        </div>
                                                ...
                                                <table class="table remove-margin-b font-s13">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right" style="width: 70px;">${student.sno }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">姓名：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${student.sname }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">班级号：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${student.classno }
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right">${student.ssex }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">出生年月：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${student.sbirth }</td>
                                                        </tr>     
                                                    </tbody>
                                                </table>
                                            </div>
