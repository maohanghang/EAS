                                                ...
                                                <table class="table remove-margin-b font-s13">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right" style="width: 70px;">${teacher.tno }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">姓名：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${teacher.tname}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">职称：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${teacher.title}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right">${teacher.tel }</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">所属系代号：</td>
                                                            
                                                            <td class="font-w600 text-success text-right">${teacher.dno }</td>
                                                        </tr>
