                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">授课表 <small>All</small></h3>
                        </div>
                        <div class="block-content">
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <% 
                                    	...
                                    	List<Course> courseinfo = tdao.searchInfo(teacher.getTno());
                                    	request.setAttribute("courseinfo", courseinfo);  
                                  
                                     %>
                                <tbody>
                                 <c:forEach items="${courseinfo}" var="item" varStatus="status"> 
								  <tr>
                                   
                                        <td class="text-center">${status.index+1 }</td>
                                        <td class="font-w600">${item.cno }</td>
                                        <td class="font-w600">${item.cname }</td>
                                        <td class="font-w600">${item.credit }</td> 
                                        <td class="font-w600">${item.ctime }</td>
