			...
			<div class="">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade" id="teacher">
						<form action="${pageContext.request.contextPath}/TeacherLogin" method="post" class="form_post">
							<div id="lo-form">
					...
					<div class="tab-pane fade" id="admin">
						<form action="${pageContext.request.contextPath}/AdminLogin" method="post" class="form_post">
							<div id="lo-form">
				
			    			<div class="form-group">
			    			<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input class="form-control input-lg" id="registid" name="adminid" placeholder="账号" type="text">
							</div>
